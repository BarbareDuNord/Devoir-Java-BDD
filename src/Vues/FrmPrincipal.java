...
public class FrmPrincipal extends javax.swing.JFrame {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        for(Employe emp : fm.GetAllEmployes())
        {
            cboEmployes.addItem(emp.getNomEmploye());
        }
        
        for(Rayon unRayon : fm.GetAllRayonsByIdsecteur(PROPERTIES))
        {
            v = new Vector();
            v.add(unRayon.getIdSecteur());
            v.add(unRayon.getNomSecteur());
    ...
    private void tblSecteursMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblSecteursMouseClicked
        while(dtmSecteurs.getRowCount()!=0)
        {
    ...
    private void btnModifierMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnModifierMouseClicked
        if(cboEmployes.getSelectedItem().toString().compareTo("")==0){
            JOptionPane.showMessageDialog(this, "Veuillez sélectionner un employé.");
        }
        else if(tblRayons.getSelectedRowCount() == 0)
        {
            JOptionPane.showMessageDialog(this, "Veuillez sélectionner un rayon.");
        }
        else if(tblSecteurs.getSelectedRowCount() == 0)
        {
            JOptionPane.showMessageDialog(this, "Veuillez sélectionner un secteur.");
        }
        else if(txtTotalHeuresRayon.getText().compareTo("")==0){
            JOptionPane.showMessageDialog(this, "Veuillez saisir un total d'heures.");
        }
        else{
            int numEmploye = fm.GetIdEmployeByNom(cboEmployes.getSelectedItem().toString());
            fm.InsererTemps(Integer.parseInt(txtTotalHeuresRayon.getText(), cboEmployes.getSelectedItem(), txtTotalHeuresRayon.getText()));
            mdlEmployes = new mod
        }
